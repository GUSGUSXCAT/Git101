...
<body>
  <section class="row">
    <aside class="col-3 col-xl-2 bg-pr full-height-overflow" style="border: 8px solid blue;">
      <ul>
        <a href="./">
    ...
    <main class="col-9 col-xl-10 bg-gray-100 border-min full-height-overflow" style="border: 8px solid red;">
      <div class="container">
